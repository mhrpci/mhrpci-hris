<!-- resources/views/loansss/show.blade.php -->
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                @can('loansss-delete')
                    ...
                    @endcan
                    @can('loansss-edit')
                      <a href="{{ route('loansss.edit',$loansss->id) }}" class="btn btn-sm btn-secondary float-right" style ="margin-right:5px;"><i class="fas fa-edit"></i>&nbsp;Edit</a>
                    @endcan
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <p>{{ $loansss->employee->sss_no }}</p>
                    </div>
                    <div class="form-group">
                        <label for="employee_id">Employee ID:</label>
                        <p>{{ $loansss->employee->company_id }}</p>
                    </div>
                    <div class="form-group">
